...
def imperialCourt(gameState):
    ...
    def generateScene(gameState):
        ...
        choiceContinue = events.GetUserChoice.Choice('Modest')
        choiceProud = events.GetUserChoice.Choice('Proud')
        ns.addEvent(events.GetUserChoice("Are you ...", [choiceContinue, choiceProud]))
        def choiceProudFn(scene):
            ...
            choiceContinue.func(scene)
        choiceProud.func = choiceProudFn
        def choiceContinueFn(scene):
        ...
        choiceContinue.func = choiceContinueFn
