...
class Console:
    def __init__(self, screen, rect, globals = None, functions={}, key_calls={}, vars={}, syntax={}):
        ...
        self.add_key_calls({"l":self.clear, "c":self.clear_input})
    ...
    def set_interpreter(self):
        if self.python_mode:
            ...
            self.python_interpreter = InteractiveConsole(self.globals)
            self.tmp_fds = []
